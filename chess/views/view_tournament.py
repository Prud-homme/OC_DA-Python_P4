def display_menu_tournament_main():
    """Display the tournament menu and return the choice"""
    menu = f"""\x1b[32m>>>  Tournament - Menu <<<\x1b[0m
1: New tournament
2: Load a tournament
...
def display_menu_tournament_resume():
    """Display the load menu and return the choice"""
    menu = f"""\x1b[32m>>> Tournament - Resume <<<\x1b[0m
...
def display_menu_tournament_lack_players():
    """Display the load menu and return the choice"""
    menu = f"""\x1b[32m>>> Tournament - Resume <<<\x1b[0m
1: View tournament informations
...
def display_menu_tournament_complete():
    """Display the load menu and return the choice"""
    menu = f"""\x1b[32m>>> Tournament - Resume <<<\x1b[0m
1: View tournament informations
